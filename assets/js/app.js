$(function () {
        ...
        if(windowWidth > 992) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', 'https://www.ajmgrupo.com/assets/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', 'https://www.ajmgrupo.com/assets/img/logos/logo.png');
                }
            }
        } else {
            $('.logo img').attr('src', 'https://www.ajmgrupo.com/assets/img/logos/black-logo.png');
   ...
   $(".dropdown").on('hover', function () {
	...
	$('.parallax-window').parallax({imageSrc: 'assets/img/fondo-paralax.jpg'});
});
